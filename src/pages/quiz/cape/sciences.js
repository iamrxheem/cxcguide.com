      ...
      <>
        <Layout>
          <SEO
            ...
            title="CAPE Science and Maths Quiz"
            description="Prepare for your CAPE science and mathematics exams with our online multiple choice quizzes."
          />
                      ...
                      trigger={
                        <>
                          <i
                            ...
                            style={{color: "#FF08D7"}}
                          ></i>
                          <a className="text-blue-500">Agricultural Science</a>
                        </>
                      }
                    >
                      <ul className=" ml-5">
                      ...
                      trigger={
                        <>
                          <i
                            ...
                            style={{color: "#FF08D7"}}
                          ></i>
                          <a className="text-blue-500">Applied Mathematics</a>
                        </>
                      }
                    >
                      <ul className=" ml-5">
                      ...
                      trigger={
                        <>
                          <i
                            ...
                            style={{color: "#FF08D7"}}
                          ></i>
                          <a className="text-blue-500">Biology</a>
                        </>
                      }
                    >
                      <ul className=" ml-5">
                      ...
                      trigger={
                        <>
                          <i
                            ...
                            style={{color: "#FF08D7"}}
                          ></i>
                          <a className="text-blue-500">Green Engineering</a>
                        </>
                      }
                    >
                      <ul className=" ml-5">
                      ...
                      trigger={
                        <>
                          <i
                            ...
                            style={{color: "#FF08D7"}}
                          ></i>
                          <a className="text-blue-500">Environmental Science</a>
                        </>
                      }
                    >
                      <ul className=" ml-5">
                      ...
                      trigger={
                        <>
                          <i
                            ...
                            style={{color: "#FF08D7"}}
                          ></i>
                          <a className="text-blue-500">Physics</a>
                        </>
                      }
                    >
                      <ul className=" ml-5">
                      ...
                      trigger={
                        <>
                          <i
                            ...
                            style={{color: "#FF08D7"}}
                          ></i>
                          <a className="text-blue-500">Pure Mathematics</a>
                        </>
                      }
                    >
                      <ul className=" ml-5">
                      ...
                      trigger={
                        <>
                          <i
                            ...
                            style={{color: "#FF08D7"}}
                          ></i>
                          <a className="text-blue-500">Digital Media</a>
                        </>
                      }
                    >
                      <ul className=" ml-5">
