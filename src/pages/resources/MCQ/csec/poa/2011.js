  ...
  return (
    <>
      <SEO
        ...
        title="CSEC Principles of Accounts 2011 Paper 1 Answers"
      ...
      <Layout>
        <section className="flex-1 full max-w-4xl px-4 mx-auto md:py-5">
          <Breadcrumb>
            ...
            <BreadcrumbItem title="2011" href="/resources/mcq/csec" />
          </Breadcrumb>
        </section>
        ...
        <section className="flex-1 full max-w-6xl px-4 mx-auto py-3">
          ...
          <h1 className="text-xl text-gray-700">
            Principles of Accounts 2011 MC Answers
          </h1>
          <br />
          <p className="mt-0 mb-4 text-base text-gray-600">
            These are the answers for the Principles of Accounts 2011 exams.
          </p>
