  ...
  return (
    <>
      <SEO
        ...
        description="Download free CSEC Principles of Accounts 2018 multiple choice answers for both January and June exas, and study online with our online study guide."
      />
      ...
      <Layout>
        ...
        <section className="flex-1 full max-w-6xl px-4 mx-auto py-3">
          ...
          <h1 className="text-xl text-gray-700">
            Principles of Accounts 2018 MC Answers
          </h1>
          <br />
          <p className="mt-0 mb-4 text-base text-gray-600">
            These are the answers for the Principles of Accounts 2018 exams.
          </p>
