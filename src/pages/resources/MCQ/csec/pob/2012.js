  ...
  return (
    <>
      <SEO
        ...
        title="CSEC Principles of Business 2012 Paper 1 Answers"
        description="Download free CSEC Principles of Business 2012 multiple choice answers for both January and June exas, and study online with our online study guide."
      />
      ...
      <Layout>
        <section className="flex-1 full max-w-4xl px-4 mx-auto md:py-5">
          <Breadcrumb>
            ...
            <BreadcrumbItem title="2012" href="/resources/mcq/csec" />
          </Breadcrumb>
        </section>
        ...
        <section className="flex-1 full max-w-6xl px-4 mx-auto py-3">
          ...
          <h1 className="text-xl text-gray-700">
            Principles of Business 2012 MC Answers
          </h1>
          <br />
          <p className="mt-0 mb-4 text-base text-gray-600">
            These are the answers for the Principles of Business 2012 exams.
          </p>
