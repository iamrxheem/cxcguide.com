    ...
    <>
      <SEO
        keywords={[
          ...
          `cxcguide`,
          `Raheem McDonald`,
          `cxc Human and Social Biology past paper solutions`,
          `2019`,
          `june`,
          `july`,
          `cxc`,
        ...
        title="CSEC Human and Social Biology 2017 Paper 1 Answers"
        description="Download free CSEC Human and Social Biology 2017 multiple choice answers for both January and June exas, and study online with our online study guide."
      />
      ...
      <Layout>
        <section className="flex-1 full max-w-4xl px-4 mx-auto md:py-5">
          <Breadcrumb>
            ...
            <BreadcrumbItem
              href="/resources/MCQ/csec/Human and Social Biology"
              title="HSB"
              notLast
            />

            <BreadcrumbItem title="2017" href="/resources/MCQ/csec" />
          </Breadcrumb>
        </section>
        ...
        <section className="flex-1 full max-w-6xl px-4 mx-auto py-3">
          ...
          <h1 className="text-xl text-gray-700">
            Human and Social Biology 2017 MC Answers
          </h1>
          <br />
          <p className="mt-0 mb-4 text-base text-gray-600">
            These are the answers for the Human and Social Biology 2017 exams.
          </p>
