  ...
  return (
    <>
      <SEO
        ...
        title="CSEC Human and Social Biology 2019 Paper 1 Answers"
      ...
      <Layout>
        ...
        <section className="flex-1 full max-w-6xl px-4 mx-auto py-3">
          ...
          <h1 className="text-xl text-gray-700">
            Human and Social Biology 2010 MC Answers
          </h1>
          <br />
          <p className="mt-0 mb-4 text-base text-gray-600">
            These are the answers for the Human and Social Biology 2010 exams.
          </p>
