  ...
  return (
    <>
      <SEO
        ...
        title="CSEC English A 2011 Paper 1 Answers"
      ...
      <Layout>
        ...
        <section className="flex-1 full max-w-6xl px-4 mx-auto py-3">
          <br />
          <h1 className="text-xl text-gray-700">English A 2011 MC Answers</h1>
          <br />
          <p className="mt-0 mb-4 text-base text-gray-600">
            These are the answers for the English A 2011 exams.
          </p>
