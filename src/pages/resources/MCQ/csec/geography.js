      ...
      <>
        <Layout>
          <SEO
            ...
            title="CSEC Geography Multiple Choice Answers"
            description="Download free CSEC Geography multiple choice answers, and study online with our online study guide."
          />
          ...
          <section className="flex-1 full max-w-4xl px-4 mx-auto md:py-5">
            ...
            <MobileView>
              <img
                className="rounded"
                src="https://study.com/cimages/videopreview/videopreview-full/p3c2j8y73a.jpg"
                style={{width: "100%"}}
              />
            </MobileView>
            <br />

            <h1 className="text-xl text-gray-700">CSEC Geography MC Answers</h1>
