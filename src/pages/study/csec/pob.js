      ...
      <>
        <Layout>
          <SEO
            ...
            title="CSEC Principles of Business Online Study Guide"
            description="Start studying Principles of Business and prepare for your CSEC exams with our online notes and quizzes made by teachers from around the Caribbean"
          />
          ...
          <section className="flex-1 full max-w-4xl px-4 mx-auto md:py-5">
            <Breadcrumb>
              ...
              <BreadcrumbItem title="Principles of Business" />
            </Breadcrumb>
          </section>
