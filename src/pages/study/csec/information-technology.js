      ...
      <>
        <Layout>
          <SEO
            ...
            title="CSEC Information Technology Online Study Guide"
            description="Start studying Information Technology and prepare for your CSEC exams with our online notes and quizzes made by teachers from around the Caribbean"
          />
          ...
          <section className="flex-1 full max-w-4xl px-4 mx-auto md:py-5">
            <Breadcrumb>
              ...
              <BreadcrumbItem title="Information Technology" />
            </Breadcrumb>
          </section>
